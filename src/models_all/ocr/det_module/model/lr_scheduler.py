...
def adjust_learning_rate(optimizer, base_lr, iter, all_iters, factor=0.9,
                         warmup_iters=0, warmup_factor=1.0 / 3):
    """
    :param optimizer:
    :param base_lr: default learning rate
    :param iter: step current
    :param all_iters: len(train_loader) * num_Epoch
    :param factor:
    :param warmup_iters:
    :param warmup_factor:
    :return:
